...
local experiment_outputs_path = project_home_path + "/experiments/outputs/ace-reactprompt/Qwen/Qwen3-14B/ACE_offline_with_GT_adaptation_seed2/playbooks";
...

{
    ...
    "config": {
        ...
        "agent": {
            ...
            "generator_prompt_file_path": experiment_prompts_path + "/appworld_react_code_agent_playbook_generator_prompt.txt",
