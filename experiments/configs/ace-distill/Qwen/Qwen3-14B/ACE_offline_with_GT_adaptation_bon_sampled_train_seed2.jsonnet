...
local experiment_outputs_path = project_home_path + "/experiments/outputs/ace-distill/Qwen/Qwen3-14B/ACE_offline_with_GT_adaptation_bon_sampled_train_seed2/playbooks";
...

{
    ...
    "config": {
        ...
        "agent": {
            ...
            "playbook_delta_eval_mode": "sampled_train_pass_rate",
            "playbook_delta_eval_num_tasks": 5,
            "playbook_delta_eval_seed": 2,
            "playbook_delta_eval_exclude_current_task": true,
        },
        "dataset": "train",
        "dataset_seed": 2,
    }
