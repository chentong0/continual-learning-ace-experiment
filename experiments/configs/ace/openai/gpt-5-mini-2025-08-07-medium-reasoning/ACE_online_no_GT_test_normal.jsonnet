...
local experiment_outputs_path = project_home_path + "/experiments/outputs/ace/openai/gpt-5-mini-2025-08-07-medium-reasoning/ACE_online_no_GT_test_normal/playbooks";
...

{
    ...
    "config": {
        ...
        "agent": {
            ...
            "trained_playbook_file_path": experiment_outputs_path + "/tasks/appworld_online_trained_playbook.txt",   
